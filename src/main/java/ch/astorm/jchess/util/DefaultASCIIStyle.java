    ...
    */
    ...
    public void renderCell(char[][] cell, Coordinate cellCoordinate, Moveable moveable) {
        ...
        if (moveable instanceof Pawn) {
            renderData = moveable.getColor() == Color.WHITE ? WHITE_PAWN : BLACK_PAWN;
        } else if (moveable instanceof Rook) {
            renderData = moveable.getColor() == Color.WHITE ? WHITE_ROOK : BLACK_ROOK;
        } else if (moveable instanceof Knight) {
            renderData = moveable.getColor() == Color.WHITE ? WHITE_KNIGHT : BLACK_KNIGHT;
        } else if (moveable instanceof Bishop) {
            renderData = moveable.getColor() == Color.WHITE ? WHITE_BISHOP : BLACK_BISHOP;
        } else if (moveable instanceof Queen) {
            renderData = moveable.getColor() == Color.WHITE ? WHITE_QUEEN : BLACK_QUEEN;
        } else if (moveable instanceof King) {
            renderData = moveable.getColor() == Color.WHITE ? WHITE_KING : BLACK_KING;
        }
